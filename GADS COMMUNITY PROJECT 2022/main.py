...
# -*- coding: utf-8 -*-
"""
Created Fri Dec 2022 21:10:37 2021
...
def display():
    ...
    i = 0
    for row in cursor:
        table.insert('', i, text="GADS320" + str(row[0]), values=(row[1], row[2], row[3], row[4], row[5], row[6]))
        i = i + 1
    table.pack()
    connn.close()
...
#The SUBMIT button for Searching for Student Information
    def submit():
        ...
        i = 0
        for row in cursor:
            details.insert('', i, text="GADS320" + str(row[0]), values=(row[1], row[2], row[3], row[4], row[5], row[6]))
            i = i + 1
...
button_1 = tk.Button(mainWindow, text="Add Student", fg = 'green', command=lambda: insert(), padx=275, pady=25,
                     activebackground='grey', activeforeground='red')
button_1.pack()

button_2 = tk.Button(mainWindow, text="Update Student Details", fg = 'gold', command=lambda: update(), padx=240, pady=25,
                     activebackground='black', activeforeground='blue')
button_2.pack()

button_3 = tk.Button(mainWindow, text="View Student Details", fg = 'navy blue', command=lambda: display(), padx=248, pady=25,
                     activebackground='grey', activeforeground='green')
button_3.pack()

button_4 = tk.Button(mainWindow, text="Delete Student", fg = 'red', command=lambda: delete(), padx=267, pady=25,
                     activebackground='grey', activeforeground='white')
button_4.pack()

button_5 = tk.Button(mainWindow, text="Search Student", fg = 'dark violet', command=lambda: search(), padx=267, pady=25,
